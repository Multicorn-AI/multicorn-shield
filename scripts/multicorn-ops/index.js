...
var require_humanize_ms = __commonJS({
  "node_modules/.pnpm/humanize-ms@1.2.1/node_modules/humanize-ms/index.js"(exports, module) {
    "use strict";
...
var require_constants = __commonJS({
  "node_modules/.pnpm/agentkeepalive@4.6.0/node_modules/agentkeepalive/lib/constants.js"(exports, module) {
    "use strict";
    module.exports = {
      // agent
...
var require_agent = __commonJS({
  "node_modules/.pnpm/agentkeepalive@4.6.0/node_modules/agentkeepalive/lib/agent.js"(exports, module) {
    "use strict";
...
var require_https_agent = __commonJS({
  "node_modules/.pnpm/agentkeepalive@4.6.0/node_modules/agentkeepalive/lib/https_agent.js"(exports, module) {
    "use strict";
...
var require_agentkeepalive = __commonJS({
  "node_modules/.pnpm/agentkeepalive@4.6.0/node_modules/agentkeepalive/index.js"(exports, module) {
    "use strict";
    var HttpAgent = require_agent();
...
// node_modules/.pnpm/@anthropic-ai+sdk@0.39.0/node_modules/@anthropic-ai/sdk/_shims/registry.mjs
var auto = false;
var kind = void 0;
var fetch2 = void 0;
var Request = void 0;
...
// node_modules/.pnpm/@anthropic-ai+sdk@0.39.0/node_modules/@anthropic-ai/sdk/_shims/MultipartBody.mjs
...
// node_modules/.pnpm/@anthropic-ai+sdk@0.39.0/node_modules/@anthropic-ai/sdk/_shims/index.mjs
...
// node_modules/.pnpm/@anthropic-ai+sdk@0.39.0/node_modules/@anthropic-ai/sdk/internal/decoders/line.mjs
...
// node_modules/.pnpm/@anthropic-ai+sdk@0.39.0/node_modules/@anthropic-ai/sdk/internal/stream-utils.mjs
...
// node_modules/.pnpm/@anthropic-ai+sdk@0.39.0/node_modules/@anthropic-ai/sdk/streaming.mjs
...
// node_modules/.pnpm/@anthropic-ai+sdk@0.39.0/node_modules/@anthropic-ai/sdk/uploads.mjs
...
// node_modules/.pnpm/@anthropic-ai+sdk@0.39.0/node_modules/@anthropic-ai/sdk/pagination.mjs
...
// node_modules/.pnpm/@anthropic-ai+sdk@0.39.0/node_modules/@anthropic-ai/sdk/resource.mjs
...
// node_modules/.pnpm/@anthropic-ai+sdk@0.39.0/node_modules/@anthropic-ai/sdk/resources/beta/models.mjs
...
// node_modules/.pnpm/@anthropic-ai+sdk@0.39.0/node_modules/@anthropic-ai/sdk/internal/decoders/jsonl.mjs
...
// node_modules/.pnpm/@anthropic-ai+sdk@0.39.0/node_modules/@anthropic-ai/sdk/resources/beta/messages/batches.mjs
...
// node_modules/.pnpm/@anthropic-ai+sdk@0.39.0/node_modules/@anthropic-ai/sdk/_vendor/partial-json-parser/parser.mjs
var tokenize = (input) => {
  let current = 0;
  let tokens = [];
...
// node_modules/.pnpm/@anthropic-ai+sdk@0.39.0/node_modules/@anthropic-ai/sdk/lib/BetaMessageStream.mjs
...
// node_modules/.pnpm/@anthropic-ai+sdk@0.39.0/node_modules/@anthropic-ai/sdk/resources/beta/messages/messages.mjs
...
// node_modules/.pnpm/@anthropic-ai+sdk@0.39.0/node_modules/@anthropic-ai/sdk/resources/beta/beta.mjs
...
// node_modules/.pnpm/@anthropic-ai+sdk@0.39.0/node_modules/@anthropic-ai/sdk/resources/completions.mjs
...
// node_modules/.pnpm/@anthropic-ai+sdk@0.39.0/node_modules/@anthropic-ai/sdk/resources/messages/batches.mjs
...
// node_modules/.pnpm/@anthropic-ai+sdk@0.39.0/node_modules/@anthropic-ai/sdk/lib/MessageStream.mjs
...
// node_modules/.pnpm/@anthropic-ai+sdk@0.39.0/node_modules/@anthropic-ai/sdk/resources/messages/messages.mjs
...
// node_modules/.pnpm/@anthropic-ai+sdk@0.39.0/node_modules/@anthropic-ai/sdk/resources/models.mjs
...
function formatComment(personas, oss) {
  ...
  for (const p2 of personas) {
    const status = p2.verdict === "pass" ? "Passed" : "**Concern**";
    const prim = p2.primary ? "yes" : "no";
    const sum = p2.summary.replace(/\|/g, "\\|");
    lines.push(`| ${p2.name} | ${p2.role} | ${prim} | ${status} | ${sum} |`);
  }
  const withConcerns = personas.filter(
    (p2) => p2.verdict === "concern" && (p2.concerns.length > 0 || p2.summary)
  );
  if (withConcerns.some((p2) => p2.concerns.length > 0)) {
    lines.push("", "### Concerns");
    for (const p2 of personas) {
      if (p2.concerns.length === 0) continue;
      lines.push("", `**${p2.name} (${p2.role})**`);
      for (const c2 of p2.concerns) {
        const loc = c2.line != null ? `\`${c2.file}:${String(c2.line)}\`` : `\`${c2.file}\``;
        lines.push(`- ${loc} - ${c2.message}`);
      }
    }
  } else if (personas.some((p2) => p2.verdict === "concern")) {
    lines.push("", "### Concerns");
    for (const p2 of personas) {
      if (p2.verdict !== "concern") continue;
      lines.push("", `**${p2.name}** - ${p2.summary}`);
    }
  }
  if (oss && oss.length > 0) {
    lines.push("", "### Open-Source Readiness Checklist");
    const bySection = /* @__PURE__ */ new Map();
    for (const row of oss) {
    ...
    for (const [section, items] of bySection) {
      ...
      for (const i2 of items) {
        const mark = i2.verdict === "pass" ? "[x]" : i2.verdict === "concern" ? "[ ]" : "[~]";
        let line = `- ${mark} ${i2.item}`;
        if (i2.note) line += ` \u2014 ${i2.note}`;
        lines.push(line);
      }
    }
  }
  lines.push(
    "",
    "---",
    "*Advisory only. Does not block merge. Actions logged to Shield as pr_review" + (oss && oss.length > 0 ? " and oss_check" : "") + ".*"
  );
  return lines.join("\n");
}
...
async function fetchPrDiff(token, owner, repo, prNumber) {
  const url = `${API}/repos/${owner}/${repo}/pulls/${prNumber}`;
  ...
  if (!res.ok) {
    throw new Error(`GitHub diff failed: ${String(res.status)} ${await res.text()}`);
  }
  return res.text();
}
async function findMulticornOpsCommentId(token, owner, repo, prNumber) {
  const url = `${API}/repos/${owner}/${repo}/issues/${prNumber}/comments?per_page=100`;
  const res = await fetch(url, {
    headers: {
  ...
  const marker = "## multicorn-ops review";
  for (const c2 of comments) {
    if (c2.body?.trimStart().startsWith(marker)) return c2.id;
  }
  return null;
}
async function postIssueComment(token, owner, repo, prNumber, body) {
  const url = `${API}/repos/${owner}/${repo}/issues/${prNumber}/comments`;
  const res = await fetch(url, {
    method: "POST",
    headers: {
      Accept: "application/vnd.github+json",
  ...
  if (!res.ok) {
    throw new Error(`GitHub post comment failed: ${String(res.status)} ${await res.text()}`);
  }
}
async function patchIssueComment(token, owner, repo, commentId, body) {
  const url = `${API}/repos/${owner}/${repo}/issues/comments/${commentId}`;
  const res = await fetch(url, {
    method: "PATCH",
    headers: {
      Accept: "application/vnd.github+json",
  ...
  if (!res.ok) {
    throw new Error(`GitHub patch comment failed: ${String(res.status)} ${await res.text()}`);
  }
}
function parseRepo(full) {
  const parts = full.split("/");
  if (parts.length !== 2 || !parts[0] || !parts[1]) {
    throw new Error(`Invalid REPO_NAME: ${full} (expected owner/repo)`);
  }
...
var PERSONAS = [
  {
    ...
    prompt: `You are Jordan, a senior security engineer at an enterprise customer evaluating Shield for a regulated environment.
Look for: API keys hashed and never logged. Input validated at boundary. No injection vectors. Audit log integrity. Minimal trusted dependencies. Clear security model. Error messages that do not leak internals.
Flag anything that could become a security incident or trust failure.`
  },
  {
    id: "priya",
    name: "Priya",
    role: "Open Source Contributor",
    prompt: `You are Priya, a mid-level dev who found Shield on Hacker News. She has 30 minutes to clone, understand, run tests, and contribute.
Look for: Clear README impact. Sensible structure. Self-explanatory names. Tests for new code. CONTRIBUTING-friendly changes. Dev tooling and CI clarity.`
  },
  {
    id: "marcus",
    name: "Marcus",
    role: "Design-Conscious Developer",
    prompt: `You are Marcus, a frontend dev evaluating Shield for his startup. He judges the product by UI quality.
Look for: Polished UI, human language (not implementation jargon), spacing, typography, loading states, mobile-friendly layout where UI changed.`
  },
  {
    id: "sarah",
    name: "Sarah",
    role: "Non-Technical Decision-Maker",
    prompt: `You are Sarah, a startup CEO evaluating Shield for her 15-person team. She needs to trust the product in 60 seconds.
Look for: User-facing copy, labels, onboarding text, pricing or marketing touchpoints. Jargon that would confuse a non-developer.`
  },
  {
    id: "the_team",
    name: "The Team",
    role: "Acquisition Due Diligence",
    prompt: `You represent 3-5 engineers from Anthropic/OpenAI/Microsoft doing acqui-hire due diligence in two weeks.
Look for: Architecture consistency, test coverage signals, security red flags, dependency hygiene, tech debt, deployability, OSS health signals in the diff.`
  },
  {
    id: "alex",
    name: "Alex",
    role: "Accessibility Advocate",
    prompt: `You are a developer who uses a screen reader part-time.
Look for: Keyboard navigation, ARIA, semantic HTML, focus states, colour-not-only status, zoom-friendly layout where UI changed.`
  },
  {
    id: "yuki",
    name: "Yuki",
    role: "International User",
    prompt: `You are a developer in Tokyo with good but non-native English. You use SDK docs and dashboard daily.
Look for: Plain English, no idioms or slang in user-facing strings and errors. Actionable error messages. Copy-pasteable examples in docs.`
  }
];
...
function changedFilesFromDiff(diff) {
  const files = [];
  const re2 = /^diff --git a\/(.+?) b\//gm;
  let m2;
  while ((m2 = re2.exec(diff)) !== null) {
    files.push(m2[1] ?? "");
  }
...
function extOf(path) {
  ...
  return i2 >= 0 ? path.slice(i2).toLowerCase() : "";
}
function inferChangeTypes(files) {
  const types = /* @__PURE__ */ new Set();
  for (const f2 of files) {
    const lower = f2.toLowerCase();
    if (lower.includes("readme") || lower.includes("contributing")) types.add("documentation");
    if (lower.endsWith(".md") || lower.includes("/docs/")) types.add("documentation");
    if (lower.includes("package.json") || lower.includes("pnpm-lock") || lower.includes("gradle"))
      types.add("dependency");
    if (lower.includes("multicorn-shield") || lower.includes("shield/") || lower.includes("src/openclaw"))
      types.add("sdk");
    if (lower.includes("consent")) types.add("consent_ui");
    if (lower.match(/\.(tsx|jsx|vue|svelte)$/)) types.add("dashboard_ui");
    if (lower.includes("multicorn-learn") || lower.includes("app/") || lower.includes("content/"))
      types.add("marketing");
    if (lower.match(/\.(kt|kts)$/) || lower.includes("controller") || lower.includes("service"))
      types.add("backend");
    if (lower.includes("security") || lower.includes("auth")) types.add("security");
  }
  if (files.some((f2) => UI_EXTENSIONS.has(extOf(f2)))) types.add("ui");
  return types;
}
var PRIMARY_MAP = {
  sdk: ["priya", "jordan", "yuki", "the_team"],
  consent_ui: ["marcus", "alex", "sarah", "jordan"],
  backend: ["jordan", "the_team", "yuki"],
  dashboard_ui: ["marcus", "sarah", "alex"],
  marketing: ["sarah", "marcus", "yuki"],
  security: ["jordan", "the_team"],
  documentation: ["priya", "yuki", "the_team"],
  architecture: ["the_team", "jordan", "priya"],
  dependency: ["jordan", "the_team", "priya"]
};
function primaryPersonaIds(files) {
  const types = inferChangeTypes(files);
  const primary = /* @__PURE__ */ new Set();
  if (types.has("security")) {
    PERSONA_IDS.forEach((id) => primary.add(id));
    return primary;
  }
  for (const [key, ids] of Object.entries(PRIMARY_MAP)) {
    if (key === "sdk" && types.has("sdk") || key === "consent_ui" && types.has("consent_ui") || key === "backend" && types.has("backend") || key === "dashboard_ui" && types.has("dashboard_ui") || key === "marketing" && types.has("marketing") || key === "documentation" && types.has("documentation") || key === "dependency" && types.has("dependency")) {
      ids.forEach((id) => primary.add(id));
    }
  }
  if (primary.size === 0) {
    ["jordan", "the_team", "priya", "yuki"].forEach(
      (id) => primary.add(id)
    );
  }
  return primary;
}
function includeUxAccessibilitySection(files) {
...
var BASE_SECTIONS = [
  {
    ...
    items: [
      ...
      "No hardcoded secrets, API keys, internal URLs, or employee names in code or comments",
      "No // TODO without a public issue reference",
      "No commented-out code blocks",
      "No debug logging (console.log, println) left in",
      "All any types eliminated (TypeScript)",
      "Error handling is complete \u2014 no swallowed exceptions, no empty catch blocks",
      "No Atlassian-internal references, no proprietary patterns or terminology"
    ]
  },
  {
    title: "Testing",
    items: [
      ...
      "Coverage meets or exceeds repo minimum",
  ...
  },
  {
    title: "Security",
    items: [
      "No secrets in code, comments, config files, or git history",
  ...
  },
  {
    ...
    items: [
      ...
      "CONTRIBUTING.md is accurate and up to date",
      "CHANGELOG.md updated with this change",
      "New public APIs have JSDoc/KDoc with examples",
      "Any new config options are documented",
      "Architecture decisions documented in ADR if significant"
    ]
  },
  {
    title: "Open Source Hygiene",
    items: [
      "Licence header present in source files (if required by licence)",
      "CODE_OF_CONDUCT.md present",
      "Issue templates are current",
      "PR template is current",
      "No internal company references or links",
      "Package name and description are correct in package.json",
      "Repository topics/tags are set on GitHub"
    ]
  }
];
var UX_SECTION = {
  title: "UX & Accessibility (UI changes only)",
  items: [
...
function buildOssPrompt(diff, includeUx) {
  const sections = includeUx ? [...BASE_SECTIONS, UX_SECTION] : [...BASE_SECTIONS];
  const checklist = sections.map((s2) => `### ${s2.title}
${s2.items.map((i2) => `- ${i2}`).join("\n")}`).join("\n\n");
  return `You are evaluating a pull request diff against the Open Source Readiness Checklist below.

For EACH checklist item, respond with one row in a JSON array. Use verdict: "pass" if the diff suggests the item is satisfied or not violated, "concern" if the diff suggests a violation or gap, "not_applicable" if the item cannot be judged from the diff alone (e.g. CI passing, repo topics on GitHub) \u2014 add a short note for not_applicable.

Return ONLY valid JSON in this exact shape (no markdown fence):
{"items":[{"section":"Code Quality","item":"All functions have clear, descriptive names","verdict":"pass|concern|not_applicable","note":"optional"}]}
...
function parseOssJson(text) {
  ...
  try {
    ...
    return parsed.items.filter((i2) => i2.section && i2.item && i2.verdict).map((i2) => ({
      section: String(i2.section),
      item: String(i2.item),
      verdict: i2.verdict === "concern" || i2.verdict === "not_applicable" ? i2.verdict : "pass",
      note: typeof i2.note === "string" ? i2.note : void 0
    }));
  } catch {
    return [];
  }
...
var TIMEOUT_MS = 15e3;
var AGENT_NAME = "multicorn-ops";
async function findAgentId(apiKey, baseUrl) {
  try {
    const res = await fetch(`${baseUrl.replace(/\/$/, "")}/api/v1/agents`, {
    ...
    const match = body.data.find((a2) => a2.name === AGENT_NAME);
    return match?.id ?? null;
  } catch {
    return null;
  }
}
async function registerAgent(apiKey, baseUrl) {
  try {
    const res = await fetch(`${baseUrl.replace(/\/$/, "")}/api/v1/agents`, {
      method: "POST",
      headers: {
...
async function ensurePermissions(agentId, apiKey, baseUrl) {
  const url = `${baseUrl.replace(/\/$/, "")}/api/v1/agents/${agentId}/permissions`;
  const scopes = [
    { service: "code", read: true, write: false, execute: false },
    { service: "comments", read: false, write: true, execute: false }
  ];
  try {
    await fetch(url, {
      method: "PUT",
...
async function ensureMulticornOpsAgent(apiKey, baseUrl) {
  let id = await findAgentId(apiKey, baseUrl);
  if (!id) id = await registerAgent(apiKey, baseUrl);
  if (id) await ensurePermissions(id, apiKey, baseUrl);
}
async function logShieldAction(apiKey, baseUrl, actionType, metadata) {
...
var ACTION_READ_CODE = "pr_review_read";
var ACTION_OSS_READ = "oss_check_read";

// src/index.ts
function requireEnv(name) {
  const v2 = process.env[name];
  if (!v2) throw new Error(`Missing required env: ${name}`);
  return v2;
}
async function main() {
  const token = requireEnv("GITHUB_TOKEN");
  const anthropicKey = requireEnv("ANTHROPIC_API_KEY");
  const shieldKey = requireEnv("MULTICORN_SHIELD_API_KEY");
  const shieldUrl = process.env.SHIELD_API_URL?.replace(/\/$/, "") || "https://api.multicorn.ai";
  const repoFull = requireEnv("REPO_NAME");
  const prNumber = Number.parseInt(requireEnv("PR_NUMBER"), 10);
  if (Number.isNaN(prNumber)) throw new Error("PR_NUMBER must be a number");
  const isPublic = process.env.IS_PUBLIC_REPO === "true";
  ...
  if (existingId != null) {
    ...
    await postIssueComment(token, owner, repo, prNumber, body);
  }
  await ensureMulticornOpsAgent(shieldKey, shieldUrl);
  await logShieldAction(shieldKey, shieldUrl, ACTION_READ_CODE, {
    event: "pr_review",
    repo: repoFull,
    pr: prNumber,
    personas_pass: personas.filter((p2) => p2.verdict === "pass").length,
    personas_concern: personas.filter((p2) => p2.verdict === "concern").length
  });
  if (isPublic && oss && oss.length > 0) {
    await logShieldAction(shieldKey, shieldUrl, ACTION_OSS_READ, {
      event: "oss_check",
      repo: repoFull,
      pr: prNumber,
      oss_concerns: oss.filter((o2) => o2.verdict === "concern").length
    });
  }
}
main().catch((e2) => {
